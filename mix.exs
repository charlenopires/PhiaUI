defmodule PhiaUi.MixProject do
  ...
  defp package do
    [
      name: "phia_ui",
      description:
        "shadcn/ui-inspired component library for Phoenix LiveView with eject-based distribution. CSS-first theme system, 75+ components, enterprise analytics widgets.",
      licenses: ["MIT"],

defmodule PhiaUi.ComponentRegistry do
  ...
  @registry %{
    ...
    dialog: %{
      ...
      js_hooks: ["PhiaFocusTrap", "PhiaDialog"],
      dependencies: [],
      tier: :interactive,
    ...
    dropdown_menu: %{
      ...
      js_hooks: ["ClickOutside", "PhiaDropdownMenu"],
      dependencies: [],
      tier: :interactive,
    ...
    drawer: %{
      ...
      js_hooks: ["PhiaFocusTrap", "PhiaDrawer"],
      dependencies: [],
      tier: :interactive,
    ...
    date_picker: %{
      ...
      js_hooks: ["PhiaCalendar", "ClickOutside"],
    ...
    combobox: %{
      ...
      js_hooks: ["PhiaCommand", "ClickOutside"],

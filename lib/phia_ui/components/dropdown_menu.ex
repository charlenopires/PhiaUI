defmodule PhiaUi.Components.DropdownMenu do
  ...
  attr(:rest, :global,
    doc: "Extra HTML attributes forwarded to the menu panel `<div>`"
  )
  ...
  attr(:checked, :boolean,
    default: false,
    doc: "Whether the option is currently checked (enabled). Drives `aria-checked` and the checkmark icon."
  )
  ...
  attr(:checked, :boolean,
    default: false,
    doc: "Whether this option is currently selected. Drives `aria-checked` and the bullet indicator."
  )

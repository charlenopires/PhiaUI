defmodule PhiaUi.Components.Breadcrumb do
  ...
  attr(:rest, :global, doc: "HTML attributes forwarded to the `<nav>` element (e.g. `data-testid`).")
  ...
  attr(:class, :string, default: nil, doc: "Additional CSS classes applied to the `<ol>` element.")
  attr(:rest, :global, doc: "HTML attributes forwarded to the `<ol>` element.")
  slot(:inner_block, required: true, doc: "Should contain `breadcrumb_item/1` and `breadcrumb_separator/1` children.")
  ...
  slot(:inner_block, required: true, doc: "A `breadcrumb_link/1`, `breadcrumb_page/1`, or `breadcrumb_ellipsis/1`.")
  ...
  attr(:navigate, :string, default: nil, doc: "Phoenix LiveView `phx-navigate` path (client-side navigation without full page reload).")
  attr(:class, :string, default: nil, doc: "Additional CSS classes applied to the `<a>` element.")
  attr(:rest, :global, doc: "HTML attributes forwarded to the `<a>` element (e.g. `target`, `rel`).")
  ...
  attr(:class, :string, default: nil, doc: "Additional CSS classes applied to the separator `<li>`.")
  slot(:inner_block, doc: "Custom separator content. When provided, overrides the default `/` character. Ideal for an icon component.")
  ...
  attr(:class, :string, default: nil, doc: "Additional CSS classes applied to the ellipsis `<span>`.")
  attr(:rest, :global, doc: "HTML attributes forwarded to the `<span>` element.")

defmodule PhiaUi.Components.Pagination do
  ...
  attr(:class, :string, default: nil, doc: "Additional CSS classes applied to the `<nav>` element.")
  ...
  attr(:class, :string, default: nil, doc: "Additional CSS classes applied to the `<ul>` element.")
  ...
  slot(:inner_block, required: true, doc: "A `pagination_link/1`, `pagination_previous/1`, `pagination_next/1`, or `pagination_ellipsis/1`.")
  ...
  attr(:current_page, :integer, required: true, doc: "The currently active page number. Controls active styling and `aria-current`.")
  attr(:on_change, :string, default: "page-changed", doc: "The `phx-click` event name sent to the LiveView. Receives `page` as a string value via `phx-value-page`.")
  ...
  attr(:current_page, :integer, required: true, doc: "The currently active page. When `1`, the button is disabled.")
  attr(:total_pages, :integer, required: true, doc: "Total number of pages. Used to determine the page value sent on click.")
  attr(:on_change, :string, default: "page-changed", doc: "The `phx-click` event name sent to the LiveView.")
  attr(:class, :string, default: nil, doc: "Additional CSS classes applied to the `<button>` element.")
  attr(:rest, :global, doc: "HTML attributes forwarded to the `<button>` element.")
  ...
  attr(:current_page, :integer, required: true, doc: "The currently active page. When equal to `total_pages`, the button is disabled.")
  attr(:total_pages, :integer, required: true, doc: "Total number of pages. Used to disable the button on the last page.")
  attr(:on_change, :string, default: "page-changed", doc: "The `phx-click` event name sent to the LiveView.")
  attr(:class, :string, default: nil, doc: "Additional CSS classes applied to the `<button>` element.")
  attr(:rest, :global, doc: "HTML attributes forwarded to the `<button>` element.")
  ...
  attr(:class, :string, default: nil, doc: "Additional CSS classes applied to the `<span>` element.")

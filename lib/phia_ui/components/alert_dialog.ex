defmodule PhiaUi.Components.AlertDialog do
  ...
  slot(:inner_block, required: true, doc: "`alert_dialog_title/1` and `alert_dialog_description/1`")
  ...
  slot(:inner_block, required: true, doc: "Description text — 1–3 sentences explaining consequences")

defmodule PhiaUi.Components.StepTracker do
  ...
  attr(:class, :string, default: nil, doc: "Additional CSS classes applied to the root `<ol>` element.")
  ...
  attr(:status, :string,
    ...
    doc: "Step status. Controls visual styling and ARIA attribute. One of `\"complete\"`, `\"active\"`, or `\"upcoming\"`."
  )

  attr(:label, :string, required: true, doc: "Primary step label shown beside the circle (e.g. `\"Shipping\"`).")
  attr(:step, :integer, default: nil, doc: "Step number displayed inside the circle for `upcoming` and `active` states. When `nil`, the circle is empty for non-complete steps.")
  attr(:description, :string, default: nil, doc: "Optional secondary text shown below the label. Useful for brief instructions on the active step.")

defmodule PhiaUi.Components.FilterBar do
  ...
  slot(:inner_block,
    required: true,
    doc:
      "`filter_search/1`, `filter_select/1`, `filter_toggle/1`, and/or `filter_reset/1` children"
  )
  ...
  attr(:rest, :global, doc: "HTML attributes forwarded to the `<label>` wrapper element")
